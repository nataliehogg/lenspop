...
class SourcePopulation_(Population):
    def  __init__(self,
        ...
        if population == 'lsst':
            ...
            raise ValueError(f"Unknown source population: {population}. Use 'lsst', 'jaguar', or 'cosmos'.")
    ...
    def loadcosmos(self):
        ...
        """
        raise NotImplementedError("COSMOS catalog loading not yet implemented. Use 'lsst' or 'jaguar' instead.")
